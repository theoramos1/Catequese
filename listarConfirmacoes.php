...
<div class="container" id="contentor">
 ...
 <div class="no-print">
  ...
  <li role="presentation" class="active"><a href="listarConfirmacoes.php">Crismas</a></li>
  ...
  <div class="well well-lg" style="position:relative; z-index:2;">
  	<form role="form" action="listarConfirmacoes.php" method="post">
  ...
  <div class="form-group">
	...
	<?php
        ...
        try
        {
            $result = $db->getSacramentsCivilYears(Sacraments::CHRISMATION);
        }
        catch (Exception $e)
        {
	...
	<?php
        ...
        try
        {
            $result = $db->getDistinctParishes(Sacraments::CHRISMATION);
        }
        catch (Exception $e)
        {
            echo("<div class=\"alert alert-danger\"><a href=\"#\" class=\"close\" data-dismiss=\"alert\">&times;</a><strong>Erro!</strong> " . $e->getMessage() . "</div>");
  ...
  <?php
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") 
	{
        ...
        // Get chrismation listing
        $result = null;
        try
        {
            $result = $db->getCatechumensBySacrament(Sacraments::CHRISMATION, $ano_civil, $paroquia,
        ...
        $listingResults->setEntitiesName("Crisma");
