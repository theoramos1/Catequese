...
<div class="only-print" style="position: fixed; top: 0;">
	...
	<h3>Listagem de Primeiras Comunhões</h3>
...
<div class="container" id="contentor">
 ...
 <div class="no-print">
  ...
  <li role="presentation" class="active"><a href="listarComunhoes.php">Primeiras Comunhões</a></li>
  ...
  <div class="well well-lg" style="position:relative; z-index:2;">
  	<form role="form" action="listarComunhoes.php" method="post">
  ...
  <div class="form-group">
	...
	<?php
        ...
        try
        {
            $result = $db->getSacramentsCivilYears(Sacraments::FIRST_COMMUNION);
        }
        catch (Exception $e)
        {
	...
	<?php
        ...
        try
        {
            $result = $db->getDistinctParishes(Sacraments::FIRST_COMMUNION);
        }
        catch (Exception $e)
        {
            echo("<div class=\"alert alert-danger\"><a href=\"#\" class=\"close\" data-dismiss=\"alert\">&times;</a><strong>Erro!</strong> " . $e->getMessage() . "</div>");
  ...
  <?php
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") 
	{
        ...
        // Get first communion listing
        $result = null;
        try
        {
            $result = $db->getCatechumensBySacrament(Sacraments::FIRST_COMMUNION, $ano_civil, $paroquia,
        ...
        $listingResults->setEntitiesName("Primeira Comunhão", "Primeiras Comunhões");
