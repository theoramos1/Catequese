    ...
    protected function renderBody()
    {
        ...
        ?>
            ...
            <div class="col-xs-2">
              ...
              <input type="tel" class="form-control" id="<?=$this->getID()?>_telefone" name="telefone" placeholder="<?= (Configurator::getConfigurationValueOrDefault(Configurator::KEY_LOCALIZATION_CODE) == Locale::BRASIL)?'Ex: (99) 3333-4444':'Telefone' ?>" style="cursor: auto;" value="<?= $ed_tel ?>" readonly>
