...
class UploadHandler
{
    ...
    protected $error_messages = array(
        1 => 'O ficheiro carregado excede a diretiva upload_max_filesize do ficheiro de configuração php.ini.',
        2 => 'O ficheiro carregado excede a diretiva MAX_FILE_SIZE directive especificada no formulário HTML.',
        3 => 'O ficheiro foi apenas parcialmente carregado.',
        4 => 'Nenhum ficheiro foi carregado.',
        6 => 'Diretoria temporária em falta.',
        7 => 'Falhou a escrita do ficheiro para disco.',
        8 => 'Uma extensão PHP interrompeu o carregamento do ficheiro.',
        'post_max_size' => 'O ficheiro carregado excede a diretiva upload_max_filesize do ficheiro de configuração php.ini.',
        'max_file_size' => 'O ficheiro é demasiado grande.',
        'min_file_size' => 'O ficheiro é demasiado pequeno.',
        'accept_file_types' => 'Filetype not allowed',
        'max_number_of_files' => 'Número máximo de ficheiros excedido.',
        'max_width' => 'A imagem excede a largura máxima permitida.',
        'min_width' => 'A imagem requer uma largura mínima.',
        'max_height' => 'IA imagem excede a altura máxima permitida.',
        'min_height' => 'A imagem requer uma altura mínima.',
        'abort' => 'Carregamento do ficheiro abortado.',
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => UserData::getUploadDocumentsFolder() . '/',
            'upload_url' => UserData::getUploadDocumentsFolder() . '/',
