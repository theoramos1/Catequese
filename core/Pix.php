...
class Pix {
    ...
    public static function buildPayload(string $key, string $merchantName, string $merchantCity,
                                        string $txid, ?float $amount, string $description = ''): string {
    ...
    public static function generatePayload(?float $amount): string {
