	    ...
	    <form role="form" action="gerirUtilizadores.php" method="post" onsubmit="return valida_form();" id="form_criar_utilizador">
		    ...
		    <div class="col-xs-2">
		      <label for="tel">Telefone:</label>
                      <input type="tel" class="form-control" id="telefone" name="telefone" placeholder="<?= (Configurator::getConfigurationValueOrDefault(Configurator::KEY_LOCALIZATION_CODE) == Locale::BRASIL)?'Ex: (99) 3333-4444':'Telefone' ?>">
		    </div>
		    </div>
