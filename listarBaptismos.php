...
<div class="no-print">
  ...
  <li role="presentation" class="active"><a href="listarBaptismos.php">Baptismos</a></li>
  ...
  <div class="well well-lg" style="position:relative; z-index:2;">
  	<form role="form" action="listarBaptismos.php" method="post">
  ...
  <div class="form-group">
	...
	<?php
        ...
        try
        {
            $result = $db->getSacramentsCivilYears(Sacraments::BAPTISM);
        }
        catch (Exception $e)
        {
	...
	<?php
        ...
        try
        {
            $result = $db->getDistinctParishes(Sacraments::BAPTISM);
        }
        catch (Exception $e)
        {
            echo("<div class=\"alert alert-danger\"><a href=\"#\" class=\"close\" data-dismiss=\"alert\">&times;</a><strong>Erro!</strong> " . $e->getMessage() . "</div>");
  ...
  <?php
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") 
	{
        ...
        try
        {
            $result = $db->getCatechumensBySacrament(Sacraments::BAPTISM, $ano_civil, $paroquia,
        ...
        $listingResults->setEntitiesName("Baptismo");
